...
class BankAccount:
	...
	def Deposite(self):
		self.Amount
		print("Deposite Amount is:",self.Amount)

	def Withdrow(self,Withdrow):
		self.Withdrow = self.Amount - Withdrow
		print("Amount after Withdraw is:",self.Withdrow)
	
	def CalculateIntrest(self):
		interest = 0
		interest = BankAccount.ROI*self.Withdrow
		print("interestof amount is:",interest)

def main():
	obj = BankAccount("Amir",500000)
	retl = obj.Display()
	ret2 = obj.Deposite()
	ret3 = obj.Withdrow(10000)
	ret4 = obj.CalculateIntrest()
